...
<body>
    ...
    <!-- Konten -->
    <div class="container">
        <h1>Pilih Mode Transportasi</h1>
        <div class="transport-modes">
            <div class="mode">
                <img src="{{ asset('images/bus_mode.jpg') }}" alt="Bus">
                <a href="{{ route('pilihan.rute.transportasi') }}?mode=bus">Bus</a>
            </div>
            <div class="mode">
                <img src="{{ asset('images/kereta_mode.jpg') }}" alt="Kereta">
                <a href="{{ route('pilihan.rute.transportasi') }}?mode=kereta">Kereta</a>
            </div>
        </div>
    </div>
