...
<head>
    <meta charset="UTF-8">
    <title>Rute Bus - Transportation Smart Destination</title>
    <style>
        /* Import Google Fonts */
...
<body>
    ...
    <div class="container">
        ...
        <ul class="rute-list">
            ...
            @for ($i = 1; $i <= 10; $i++)
                <li>
                    <a href="{{ route('detail.rute.bus', ['id' => $i]) }}">Rute Bus {{ $i }}</a>
                    <p>Pemberhentian: @php echo implode(' - ', ['Stop 1', 'Stop 2', 'Stop 3', 'Stop 4']); @endphp</p>
                </li>
            @endfor
        </ul>
    </div>
